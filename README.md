...
2. [ ] Разработка
   ...
   3. [ ] Страница домов
      1. [ ] Поиск
      2. [ ] Сортировка (По названию, по цене, по площади дома). Помимо выбора поля сортировки, должна быть кнопка выбора направления сортировки
      3. [ ] Вывод домов плитками
   4. [ ] Окно авторизации
      1. [ ] Страница входа
         1. [ ] Валидация полей ввода, сохранение правильных данных
         2. [ ] 
